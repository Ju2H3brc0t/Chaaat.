...
### Birthdays
Checks daily for members whose birthday matches the current date, sends an announcement, and optionally gifts XP, roles, or a temporary role for the day.
...
### Tickets
Creates and manages support tickets in a thread.
...
The web dashboard (Flask app on port 5000) provides a visual interface to edit settings after signing in with Discord.
